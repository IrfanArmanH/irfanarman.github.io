...
<body>
    <div class="tampil-data">
        <h1 style="text-align:center;color:white;">Data Barang</h1>
        <table>
        <tr class="tr-foto">
        ...
        <tr>
            <td style="color:white;"> Angka Kode Barang : <?php echo "$_POST[kode]" ;?></td>
        </tr>
        <tr>
            <td style="color:white;"> Nama barang : <?php echo "$_POST[nama]" ;?></td>
        </tr>
        <tr style="color:white;">
            <td>Harga Barang: <?php echo "$_POST[harga]";?></td> 
        </tr>
        <tr style="color:white;">
            <td>Tangal Masuk Barang : <?php echo "$_POST[tanggal_masuk]" ;?></td> 
        </tr>
        <tr style="color:white;">
            <td>Merk Barang : <?php echo "$_POST[merk]" ;?></td> 
        </tr>
        <tr style="color:white;">
            <td>stok Barang : <?php echo "$_POST[stok]" ;?></td> 
        </tr>
